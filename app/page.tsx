  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8f7f3', fontFamily: "'DM Sans', sans-serif", overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ fontFamily: 'StealThis, cursive', fontSize: 15, letterSpacing: '0.08em', color: '#111', textTransform: 'uppercase' }}>
          White Label Player
        </div>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 1, background: 'rgba(248,247,243,0.82)' }} />

        <div className="fu d1" style={{ position: 'relative', zIndex: 2, marginBottom: 28 }}>
          <span style={{
            fontFamily: 'StealThis, cursive', fontSize: 11,
            letterSpacing: '0.22em', textTransform: 'uppercase',
            background: '#f0f0e8', border: '1.5px solid #222',
            borderRadius: 3, padding: '4px 16px', display: 'inline-block', color: '#111',
        ...
        <p className="fu d3" style={{
          position: 'relative', zIndex: 2,
          fontSize: 'clamp(15px, 2vw, 19px)', color: '#555',
        ...
        <div className="fu d4" style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
            ...
            <Link href="/login" style={{ fontSize: 12, color: '#d4820a', textDecoration: 'none', fontWeight: 500 }}>
              Sign in →
            </Link>
          </div>
          <span style={{ fontSize: 12, color: '#bbb', maxWidth: 400 }}>
      ...
      <section style={{ padding: '72px 32px 0', maxWidth: 1140, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 14, marginBottom: 14 }}>
          {cards.slice(0, 4).map(card => (
            <div key={card.label} className="card" style={{
              ...
              <div style={{ fontFamily: 'StealThis, cursive', fontSize: 13, letterSpacing: '0.06em', color: '#d4820a', marginBottom: 10, textTransform: 'uppercase' }}>
                {card.label}
              </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20, margin: '52px 0 36px' }}>
          ...
          <span style={{ fontFamily: 'StealThis, cursive', fontSize: 10, letterSpacing: '0.18em', color: '#ccc', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>And more</span>
          <div style={{ flex: 1, height: '0.5px', background: 'rgba(0,0,0,0.1)' }} />
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 14, marginBottom: 88 }}>
          {cards.slice(4).map(card => (
            <div key={card.label} className="card" style={{
              ...
              <div style={{ fontFamily: 'StealThis, cursive', fontSize: 13, letterSpacing: '0.06em', color: '#999', marginBottom: 10, textTransform: 'uppercase' }}>
                {card.label}
              </div>
      ...
      <section style={{ background: '#111', padding: '88px 24px', textAlign: 'center' }}>
        <div style={{ marginBottom: 28 }}>
          <span style={{ fontFamily: 'StealThis, cursive', fontSize: 11, letterSpacing: '0.22em', textTransform: 'uppercase', background: '#f0f0e8', color: '#111', borderRadius: 3, padding: '4px 16px', display: 'inline-block' }}>
            White Label Player
          </span>
        </div>
