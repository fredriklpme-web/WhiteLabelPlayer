...
const PRESETS: Record<MasterPreset, PresetConfig | null> = {
  off: null,
  clean: {
    highpassFreq: 40, lowShelfGain: 0.5, presenceGain: 0.8, highShelfGain: 0.8,
    compThreshold: -20, compRatio: 2.5, compAttack: 0.02, compRelease: 0.3, outputGain: 0.92,
  },
  warm: {
    highpassFreq: 35, lowShelfGain: 2.5, presenceGain: 0.5, highShelfGain: -0.5,
    compThreshold: -18, compRatio: 3, compAttack: 0.015, compRelease: 0.35, outputGain: 0.90,
  },
  loud: {
    highpassFreq: 40, lowShelfGain: 1.5, presenceGain: 1.5, highShelfGain: 1.0,
    compThreshold: -16, compRatio: 4, compAttack: 0.008, compRelease: 0.2, outputGain: 0.88,
  },
  bright: {
    highpassFreq: 45, lowShelfGain: 0, presenceGain: 2.0, highShelfGain: 2.5,
    compThreshold: -20, compRatio: 2.5, compAttack: 0.02, compRelease: 0.3, outputGain: 0.90,
  },
}
